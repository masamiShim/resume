...
#### 1. チラシデータ管理システム 2021/11 ～　
##### 概要
既存システムのチラシデータをtableauで読み込めるようにするシステム
現在は基盤構成中。  
　
##### 内容
- SpringBoot2 + Kotlin or Java(11/17) + Vue3(Typescript) + AWS
- MPA構成
- バッチ処理と管理画面の作成

#### 2. LINEヘルスケア(業務委託) 2021/7 ～　
##### 概要
LINE Official Accountの開発、（設計 / 実装） 
　
##### 内容
- Express(Typescript)/MessagingAPI + Vue2(TypeScript)/LIFF + ansible + Drone
- バッチ開発/API開発/画面実装


#### 3. オンライン授業サービス開発支援 2021/4 ～　2021/09
##### 概要
オンライン授業サービスの開発
技術検証～テストまで実装を担当。  
　
...
#### 6. ネットワーク設定自動化開発支援 2019/11 ～　2020/03
##### 概要
...
#### 9. 証券自動運用システム開発支援 2017/10 ～　2018/10
##### 概要
