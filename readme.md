...
#### 1. オンライン授業サービス開発支援 2021/4 ～　2021/09
##### 概要
オンライン授業サービスの開発
技術検証～テストまで実装を担当。  
　
...
#### 4. ネットワーク設定自動化開発支援 2019/11 ～　2020/03
##### 概要
...
#### 7. 証券自動運用システム開発支援 2017/10 ～　2018/10
##### 概要
